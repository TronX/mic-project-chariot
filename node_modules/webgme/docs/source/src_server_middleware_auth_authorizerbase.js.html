...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/server/middleware/auth/authorizerbase.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/server/middleware/auth/authorizerbase.js</h1>
...
module.exports = AuthorizerBase;</code></pre>
        </article>
    </section>
