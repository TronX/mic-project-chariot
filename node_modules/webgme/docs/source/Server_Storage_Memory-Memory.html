...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Memory</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Memory</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="Server_Storage_Memory.html">Server:Storage:Memory</a>~</span>Memory</h2>
...
<article>
    ...
    <h4 class="name" id="Memory"><span class="type-signature"></span>new Memory<span class="signature">(mainLogger)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_storage_memory.js.html">src/server/storage/memory.js</a>, <a href="src_server_storage_memory.js.html#line28">line 28</a>
    </li></ul></dd>
