...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/server/worker/workerrequests.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/server/worker/workerrequests.js</h1>
...
module.exports = WorkerRequests;</code></pre>
        </article>
    </section>
