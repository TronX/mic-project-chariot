...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: Server:API</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: Server:API</h1>
...
<dl class="details">
    ...
    <dd class="tag-author">
        <ul>
            <li>lattmann / https://github.com/lattmann</li>
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_api_index.js.html">src/server/api/index.js</a>, <a href="src_server_api_index.js.html#line4">line 4</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="~createAPI"><span class="type-signature">(inner) </span>createAPI<span class="signature">(app, mountPath, middlewareOpts)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">Express application</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">mount point e.g. /api</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>middlewareOpts</code></td>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_api_index.js.html">src/server/api/index.js</a>, <a href="src_server_api_index.js.html#line20">line 20</a>
    </li></ul></dd>
