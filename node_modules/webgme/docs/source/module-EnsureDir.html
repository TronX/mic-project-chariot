...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: EnsureDir</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: EnsureDir</h1>
...
<article>
    ...
    <h4 class="name" id="~ensureDir"><span class="type-signature">(inner) </span>ensureDir<span class="signature">(dir, mode, callback)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">The directory you want to ensure it exists</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">Refer to fs.mkdir()</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_util_ensureDir.js.html">src/server/util/ensureDir.js</a>, <a href="src_server_util_ensureDir.js.html#line56">line 56</a>
    </li></ul></dd>
