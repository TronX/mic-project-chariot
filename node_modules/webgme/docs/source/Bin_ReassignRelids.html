...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: Bin:ReassignRelids</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: Bin:ReassignRelids</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">This tool can re-assign relids of an exported project. It keeps every other information intact.This tool is advised to be used if someone has an old large project, as the reassigned relidswill be as short as possible, making the objects in the project smaller (especially the root object).</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_bin_reassign_relids.js.html">src/bin/reassign_relids.js</a>, <a href="src_bin_reassign_relids.js.html#line2">line 2</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="~main"><span class="type-signature">(inner) </span>main<span class="signature">(argv)</span><span class="type-signature"> &rarr; {undefined}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_bin_reassign_relids.js.html">src/bin/reassign_relids.js</a>, <a href="src_bin_reassign_relids.js.html#line29">line 29</a>
    </li></ul></dd>
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.0</a> on Mon Nov 28 2016 13:13:34 GMT-0600 (Central Standard Time)
</footer>
