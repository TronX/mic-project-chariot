...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/server/util/WebhookManager.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/server/util/WebhookManager.js</h1>
...
module.exports = WebhookManager;</code></pre>
        </article>
    </section>
